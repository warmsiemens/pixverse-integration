...
from app.services.video_service import (upload_image_to_get_id, text2video,
                                        image2video, get_status_generate)
...
async def generate_image2video(app_bundle_id: Annotated[str, Form(...)],
    ...
    image_id = upload_image_to_get_id(image_data, image.filename)
    result = image2video(prompt, int(image_id))
